...
<head>
	<title>Sign in | Complete Choice</title>
	<meta charset="utf-8">
		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
							<div class="logo align-center"><img src="assets/images/img/cc1.png" </div>
							<p class="lead">{{ __('Complete Choice Employee Portal') }}</p>
						</div>
						<form class="form-auth-small ui form" action="{{ route('login') }}" method="POST">
							...
							<div class="fields">
								<div class="sixteen wide field {{ $errors->has('email') ? ' has-error' : '' }}">
									...
									<input id="email" type="email" class="" name="email" value="{{ old('email') }}" placeholder="{{ __('enter your personal email') }}" required autofocus>
									@if ($errors->has('email'))
							...
							<div class="fields">
								<div class="sixteen wide field {{ $errors->has('password') ? ' has-error' : '' }}">
                                	...
                                	<input id="password" type="password" class="" name="password" placeholder="{{ __('contact: info@completechoice.com.au for password') }}" required>
