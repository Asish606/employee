@extends('layouts.default')
    ...
    @section('meta')
        <title>Dashboard | Complete Choice </title>
        <meta name="description" content="Complete Choice dashboard, view recent attendance, recent leaves of absence, and newest employees">
    @endsection
