        ...
        <nav id="sidebar" class="active">
            <div class="sidebar-header bg-lightblue">
                ...
                <a href="/" class="simple-text">
                    <img src="{{ asset('/assets/images/img/cc1.png') }}">
                </a>
                </div>
            </div>
            ...
            <ul class="list-unstyled components">
                ...
                <li class="">
			      ...
			      <li class="">
                    <a href="{{ url('https://docs.google.com/spreadsheets/d/1AdGYsaqs6tEEp1GHabC2FeI3NjqEDGExJR0v-MiQzVA/edit?usp=sharing')}}">
